export const poderesDaTormenta = {
	...
	"Cuspir Enxame": {
		nome: "Cuspir Enxame",
		descrição:
			"Você pode gastar uma ação completa e 2 PM para criar um enxame de insetos rubros. O enxame tem tamanho Médio e pode passar pelo espaço de outras criaturas. Uma vez por rodada, você pode gastar uma ação de movimento para mover o enxame 9m. No final do seu turno, o enxame causa 2d6 pontos de dano de ácido a qualquer criatura no espaço que ele estiver ocupando. Para cada dois outros poderes da Tormenta que possui, você pode gastar +1 PM quando usa este poder para aumentar o dano do enxame em +1d6.",
		tipo: "Magia",
		requisito: "Nenhum"
	},
	"Dentes Afiados": {
	...
	"Desprezar a Realidade": {
		...
		descrição:
			"Você pode gastar 2 PM para ficar no limiar da realidade até o início de seu próximo turno. Nesse estado, você ignora terreno difícil e causa 20% de chance de falha em efeitos usados contra você. Para cada dois outros poderes de Tormenta que você possuir, essa chance aumenta em 5% (máximo de 50%).",
		tipo: "Normal",
		requisito: "quatro outros poderes da Tormenta"
	},
	"Empunhadura Rubra": {
	...
	"Membros extras": {
		nome: "Membros extras",
		descrição:
			"Você possui duas armas naturais de patas insetoides. Uma vez por rodada, quando usa a ação agredir para atacar com outra arma, pode gastar 2 PM para fazer um ataque corpo a corpo extra com cada uma (dano 1d4, crítico x2, corte). Se possuir Ambidestria ou Estilo de Duas Armas, pode empunhar armas leves em suas patas insetoides (mas ainda precisa pagar 2 PM para atacar com elas e sofre a penalidade de –2 em todos os ataques).",
		tipo: "Normal",
		requisito: "quatro outros poderes da Tormenta"
	},
	"Mente Aberrante": {
