export const poderes = {
	...
	"Desarmar Aprimorado": {
		...
		descrição:
			"Você recebe +2 em testes de ataque para desarmar. Quando desarma uma criatura, pode gastar 1 PM para arremessar a arma dela para longe.",
		requisitos: "Combate Defensivo.",
		tipo: "Combate"
	},
	"Disparo Preciso": {
	...
	"Aparência Inofensiva": {
		...
		descrição:
			"A primeira criatura inteligente (Int –3 ou maior) que atacar você em uma cena deve fazer um teste de Vontade (CD Car). Se falhar, perderá sua ação. Este poder só funciona uma vez por cena.",
		requisitos: "Car 1.",
		tipo: "Destino"
	},
	Atlético: {
	...
	"Foco em Perícia": {
		...
		descrição:
			"Escolha uma perícia. Quando faz um teste dessa perícia, você pode gastar 1 PM para rolar dois dados e usar o melhor resultado. Você pode escolher este poder outras vezes para perícias diferentes.",
	...
	Medicina: {
		nome: "Medicina",
		descrição:
			"Você pode gastar uma ação completa para fazer um teste de Cura (CD 15) em uma criatura. Se você passar, ela recupera 1d6 PV, mais 1d6 para cada 5 pontos pelos quais o resultado do teste exceder a CD.",
	...
	Parceiro: {
		nome: "Parceiro",
		descrição:
			"Você possui um parceiro animal ou humanoide que o acompanha em aventuras. Escolha os detalhes dele, como nome, aparência e personalidade.",
		requisitos:
