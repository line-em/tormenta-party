export const poderesDeClasse = {
	...
	"Caldeirão do Bruxo": {
		...
		tipo: "Normal",
		requisito: "Bruxo, treinado em Ofício (alquimista)",
		classe: "Arcanista"
	},
	"Conhecimento Mágico": {
	...
	"Contramágica Aprimorada": {
		...
		tipo: "Normal",
		requisito: "Dissipar Magia",
		classe: "Arcanista"
	},
	"Envolto em Mistério": {
		nome: "Envolto em Mistério",
		descrição:
			"Sua aparência e postura assombrosas o permitem manipular e assustar pessoas ignorantes ou supersticiosas.",
		tipo: "Normal",
		requisito: "Nenhum",
		classe: "Arcanista"
	},
	"Escriba Arcano": {
		...
		tipo: "Normal",
		requisito: "Mago, treinado em Ofício (escriba)",
		classe: "Arcanista"
	},
	"Especialista em Escola": {
		...
		tipo: "Normal",
		requisito: "Bruxo ou Mago",
		classe: "Arcanista"
	},
	Familiar: {
		nome: "Familiar",
		descrição: "Você possui um animal de estimação mágico.",
		tipo: "Normal",
		requisito: "Nenhum",
		classe: "Arcanista"
	},
	...
	"Foco Vital": {
		nome: "Foco Vital",
		descrição:
			"Se você estiver segurando seu foco e sofrer dano que o levaria a 0 PV ou menos, você fica com 1 PV e o foco perde PV igual ao valor excedente ou até ser destruído.",
		tipo: "Magia",
		requisito: "Bruxo",
		classe: "Arcanista"
	},
	"Fortalecimento Arcano": {
		...
		tipo: "Normal",
		requisito: "5º nível de arcanista",
		classe: "Arcanista"
	},
	"Herança Aprimorada": {
		nome: "Herança Aprimorada",
		descrição: "Você recebe a herança aprimorada de sua linhagem sobrenatural.",
		tipo: "Normal",
		requisito: "Feiticeiro, 6º nível de arcanista",
		classe: "Arcanista"
	},
	"Herança Superior": {
		nome: "Herança Superior",
		descrição: "Você recebe a herança superior de sua linhagem sobrenatural.",
		tipo: "Normal",
		requisito: "Herança Aprimorada, 11º nível de arcanista",
		classe: "Arcanista"
	},
	"Magia Pungente": {
		nome: "Magia Pungente",
	...
	"Mestre em Escola": {
		...
		tipo: "Normal",
		requisito: "Especialista em Escola com a escola escolhida, 8º nível de arcanista",
		classe: "Arcanista"
	},
	"Poder Mágico": {
		nome: "Poder Mágico",
		descrição: "Você recebe +1 ponto de mana por nível de arcanista.",
		tipo: "Normal",
		requisito: "Nenhum",
		classe: "Arcanista"
	},
	"Raio Arcano": {
		nome: "Raio Arcano",
		descrição:
			"Você pode gastar uma ação padrão para causar 1d8 pontos de dano de essência num alvo em alcance curto.",
		tipo: "Magia",
		requisito: "Nenhum",
		classe: "Arcanista"
	},
	...
	"Tinta do Mago": {
		nome: "Tinta do Mago",
		descrição:
			"Você pode criar pergaminhos, como se tivesse o poder Escrever Pergaminho.",
		tipo: "Normal",
		requisito: "Mago, treinado em Ofício (escriba)",
		classe: "Arcanista"
	}
